...
class Model:
    ...
    my_model1 = 'best_angle.tflite'
    my_model2 = 'best_speed.tflite'
    ...
    def __init__(self):
        ...
        self.interpreter2 = tf.lite.Interpreter(model_path=os.path.join(os.path.dirname(os.path.abspath(__file__)),
                                                                       self.my_model2))
    ...
    def predict(self, image):
        ...
        self.interpreter2.set_tensor(self.input_details[0]['index'], image)  # original might work
        self.interpreter2.invoke()

        pred_speed = self.interpreter2.get_tensor(self.output_details[0]['index'])[0]
        pred_angle = self.interpreter.get_tensor(self.output_details[0]['index'])[0]
